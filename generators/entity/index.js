...
module.exports = class extends EntityGenerator {
  ...
  get preparing() {
    return {
      ...
      addHelpers() {
        ...
        this.context.getFieldColumnType = getFieldColumnType.bind(this);
        ...
        this.context.entityNamePluralSnakeCase = this._.snakeCase(this.context.entityNamePlural);
    ...
    return {
      ...
      differentRelationshipsWorkaround() {
        ...
        this.context.relationships.forEach(relation => {
          ...
          relation.otherEntityNameSnakeCase = this._.kebabCase(relation.otherEntityName);
        });
  ...
  get writing() {
    return {
      ...
      patchRoutesForEntity: patchRoutesForEntity.bind(this, this.context.name),
    };
  }
